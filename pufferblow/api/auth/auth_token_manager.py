...
class AuthTokenManager:
    ...
    def create_token(self) -> str:
        ...
        size = 41
        ascii_charachters = [
            char for char in string.ascii_lowercase + string.ascii_uppercase
        ]
        ...
        logger.info(debug.DEBUG_NEW_AUTH_TOKEN_GENERATED(auth_token=auth_token))
        return auth_token
    ...
    def create_auth_token_expire_time(self):
        ...
        if expire_time.month != 12:
            ...
            expire_time = expire_time.replace(month=1, year=expire_time.year + 1)
