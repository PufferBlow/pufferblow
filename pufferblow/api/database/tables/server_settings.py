...
class ServerSettings(Base):
    ...
    server_settings_id = Column(
        String, primary_key=True, nullable=False, default="global_settings"
    )
    ...
    )  # 10MB for animated content
    allowed_images_extensions = Column(
        ARRAY(String), default=["png", "jpg", "jpeg", "gif", "webp"], nullable=False
    )
    allowed_stickers_extensions = Column(
        ARRAY(String), default=["png", "gif"], nullable=False
    )
    allowed_gif_extensions = Column(ARRAY(String), default=["gif"], nullable=False)
    allowed_videos_extensions = Column(
        ARRAY(String), default=["mp4", "webm"], nullable=False
    )
    allowed_doc_extensions = Column(
        ARRAY(String), default=["pdf", "doc", "docx", "txt", "zip"], nullable=False
    )
