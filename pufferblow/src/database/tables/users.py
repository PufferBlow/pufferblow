...
class Users(Base):
    ...
    joined_servers_sha256   =   Column(ARRAY(String), default=[])
    ...
    def __repr__(self) -> str:
        return f"Users(user_id={self.user_id!r}, username={self.username!r}, password_hash={self.password_hash!r}, status={self.status!r}, last_seen={self.last_seen!r}, conversations={self.conversations!r}, contacts={self.contacts!r}, joined_servers_sha256={self.joined_servers_sha256!r}, auth_token={self.auth_token!r}, auth_token_expire_time={self.auth_token_expire_time!r}, is_admin={self.is_admin!r}, is_owner={self.is_owner!r}, updated_at={self.updated_at!r}, created_at={self.created_at!r})"
