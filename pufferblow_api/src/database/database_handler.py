...
class DatabaseHandler (object):
    ...
    def sign_up(self, user_data: User, is_test_mode: bool | None = False) -> None:
        ...
        user_data.raw_auth_token         = auth_token
        ...
        encrypted_auth_token, auth_token_encryption_key      =       self.hasher.encrypt(user_data.raw_auth_token)
        ...
        user_data.encrypted_auth_token    =      base64.b64encode(encrypted_auth_token).decode("ascii")
        ...
        self._save_token(
            user_data.encrypted_auth_token,
            user_data.auth_token_expire_time,
            user_data.user_id
        )

        return (user_data.raw_auth_token, user_data.auth_token_expire_time) \
                if is_test_mode != True \
                    else (user_data.raw_auth_token, user_data.auth_token_expire_time, user_data.user_id)
        ...
        try:
            with database_connection.cursor() as cursor:
                ...
                for user_data in users_data:
                    ...
                    cursor.execute(get_decryption_key_sql)
                    decryption_key = cursor.fetchall()[0][0]
